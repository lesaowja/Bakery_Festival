...
public class DataController : Singleton<DataController>
{
    ...
    public void SaveUpgradeButton(ClickUpButton clickUpButton)
    {
        ...
        PlayerPrefs.SetInt("_Clicklevel", clickUpButton.level);                 // Å°°ª(_Clicklevel)À¸·Î ÇöÀç level À» ÀúÀå.
        ...
        Debug.Log("Å¬¸¯µ¥ÀÌÅÍ ÀúÀå :" + PlayerPrefs.GetInt("_Clicklevel", clickUpButton.level));
