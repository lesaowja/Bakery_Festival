...
public class DataController : Singleton<DataController>
{
    ...
    public void SaveUpgradeButton(ClickUpButton clickUpButton)
    {
        ...
        PlayerPrefs.SetInt(key + "_Clicklevel", clickUpButton.level);                 // Å°°ª(_Clicklevel)À¸·Î ÇöÀç level À» ÀúÀå.
        ...
        PlayerPrefs.SetInt(key + "_upgradecost", clickUpButton.currentCost);            // Å°°ª(_cost)À¸·Î ÇöÀç currentCost ¸¦ ÀúÀå. (±¸¸Åºñ¿ë)
        Debug.Log("Å¬¸¯µ¥ÀÌÅÍ ÀúÀå"); 
        Debug.Log("Å¬¸¯µ¥ÀÌÅÍ ÀúÀå :" + PlayerPrefs.GetInt(key + "_Clicklevel", clickUpButton.level));
