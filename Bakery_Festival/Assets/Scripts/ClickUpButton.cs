...
public class ClickUpButton : MonoBehaviour
{
    ...
    public int startupgradeGold = 1;    // 처음 업그레이드 골드

    public int currentCost = 1;         // 현재 업그레이드 비용
    public int startcurrentCost = 1;    // 처음 업그레이드 비용

    public int level = 1;               // 업그레이드 횟수

    public float upgradePow = 1.14f;  // 업그레이드 마다 늘어나는 골드 배율 값
    public float costPow = 3.14f;     // 업그레이드 마다 추가되는 비용 배율 값
